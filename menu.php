      ...
      <div id="overlay" >
        ...
        <div id="variationDisplay" class="panel panel-default">
              ...
              <div class="o1">
                ...
                <div class="o2">
                    <button id="overlayclosebutton" onclick="overlayOff()"> close</button>
                  Body
                </div>
        </div>
    ...
    <div id="coffee"  style="display: none;">
      <div id="item1">
        ...
        <div class="btnContainer">
          <button class="btn btn-warning" onclick="overlayOn()"> Variation</button>
        </div>
      </div>
      ...
      <div id="item2">
        ...
        <div class="btnContainer">
          <button class="btn btn-warning"> Variation</button>
        </div>
      </div>
   ...
   <div class="footerMenu">
       <div class="followUs">
         ...
         <div  class="followUsText">
           Connect with us on social media to stay up-to-<br>date with the latest from The Copper Moon
         </div>
